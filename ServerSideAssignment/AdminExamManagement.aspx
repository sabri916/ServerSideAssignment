            ...
            <div class="container-fluid">
                ...
                <div>
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="AdminExamManagement.aspx">Exam Management</a></li>
    ...
    <div class="container"">
        ...
        <div class="col-md-8">
            ...
            <div class="form-group">        
                ...
                <textarea class="form-control" id="exam_description_area" runat="server" cols="20" rows="5"></textarea>
                <br />
            </div>
            ...
            <div class="form-group">        
                ...
                <asp:DropDownList CssClass="form-control" ID="hour_dropdown" runat="server">
                ...
                <asp:DropDownList CssClass="form-control" ID="minutes_dropdown" runat="server">
